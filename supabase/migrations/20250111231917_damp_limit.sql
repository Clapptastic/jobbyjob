...
begin
  ...
  drop policy if exists "process_logs_select_20250111" on public.job_processing_logs;
  drop policy if exists "process_logs_insert_20250111" on public.job_processing_logs;
  drop policy if exists "process_logs_update_20250111" on public.job_processing_logs;
  drop policy if exists "process_queue_select_20250111" on public.job_processing_queue;
  drop policy if exists "process_queue_insert_20250111" on public.job_processing_queue;
  drop policy if exists "process_queue_update_20250111" on public.job_processing_queue;
exception
